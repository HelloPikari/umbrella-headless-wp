...
class Pikari_SVG_Icons {
	...
	public static function get_svg( $group, $icon, $size ) {
		...
		if ( array_key_exists( $icon, $arr ) ) {
			$repl = sprintf( '<svg class="svg-icon fill-current" width="%d" height="%d" aria-hidden="true" role="img" focusable="false" ', $size, $size );
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <path d="M0 0h24v24H0z" fill="none"></path>
		...
		'chevron_left_thin'           => /* Font Awesome – chevron_left_thin */ '
<svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <path d="M15,17.91l.19-.19a.32.32,0,0,0,0-.46L9.9,12l5.26-5.26a.32.32,0,0,0,0-.46L15,6.09a.33.33,0,0,0-.45,0L8.84,11.77a.32.32,0,0,0,0,.46l5.68,5.68a.33.33,0,0,0,.45,0Z"></path>
    <path d="M0 0h24v24H0z" fill="none"></path>
</svg>',

		'chevron_right_thin'          => /* Font Awesome – chevron_right_thin */ '
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path d="M9,6.09l-.19.19a.32.32,0,0,0,0,.46L14.1,12,8.84,17.26a.32.32,0,0,0,0,.46l.19.19a.33.33,0,0,0,.45,0l5.68-5.68a.32.32,0,0,0,0-.46L9.48,6.09a.33.33,0,0,0-.45,0Z"></path>
    <path d="M0 0h24v24H0z" fill="none"></path>
</svg>',
	...
	'event'                  => /* material-design – event */ '
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		<path d="M15.83,12.77H12v3.82h3.83Zm-.77-8.42V5.88H8.94V4.35H7.41V5.88H6.64A1.52,1.52,0,0,0,5.12,7.41V18.12a1.53,1.53,0,0,0,1.53,1.53H17.36a1.54,1.54,0,0,0,1.53-1.53V7.41a1.54,1.54,0,0,0-1.53-1.53h-.77V4.35Zm2.3,13.77H6.64V9.7H17.36Z"/>
		<path d="M0 0h24v24H0z" fill="none"></path>
	</svg>',
	...
	'long_arrow_right'   => /* font-awesome – long_arrow_right */ '
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
		<path d="M14.77,6.57,14,7.33A.47.47,0,0,0,14,8h0l3.12,3H3.8a.47.47,0,0,0-.47.47v1.08A.47.47,0,0,0,3.8,13H17.14L14,16a.45.45,0,0,0,0,.65h0l.76.76a.47.47,0,0,0,.66,0l5.1-5.1a.47.47,0,0,0,0-.66l-5.1-5.1A.47.47,0,0,0,14.77,6.57Z"/>
		<path fill="none" d="M24 0v24H0V0h24z"></path>
	</svg>',
	...
	'play_circle_outline' => /* custom – play_circle_outline */ '
	<svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<path d="M12,22.12A10.12,10.12,0,1,1,22.12,12,10.13,10.13,0,0,1,12,22.12Zm0-19A8.9,8.9,0,1,0,20.9,12,8.91,8.91,0,0,0,12,3.1Z"/><path d="M15.09,11.5,10.4,8.73a.62.62,0,0,0-.87.21.67.67,0,0,0-.09.34v5.54a.63.63,0,0,0,.64.63.69.69,0,0,0,.32-.08l4.69-2.77a.64.64,0,0,0,.22-.88A.58.58,0,0,0,15.09,11.5Z"/>
		<path fill="none" d="M0 0h24v24H0z"/>
	</svg>',

	'dev6' => /* custom – dev6 */ '
	<svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<path d="M14,6.32a7.15,7.15,0,0,0-2.93.58,21.29,21.29,0,0,0,1.94-2.8C13.81,2.7,15.22,0,15.22,0H8.48L4.3,8.09C3,10.67,2,12.44,1.91,14.92,1.72,20.33,6.22,24,11.72,24s10.17-3.49,10.37-9.21C22.27,9.55,18.72,6.32,14,6.32ZM11.86,18.8a3.75,3.75,0,0,1-3.92-4,4.07,4.07,0,0,1,4.2-4,3.75,3.75,0,0,1,3.92,4A4.07,4.07,0,0,1,11.86,18.8Z"/>
		<path fill="none" d="M0 0h24v24H0z"/>
	</svg>',

  'devices' => /* custom – devices */ '
  <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <path d="M19.71,8.5H15.5V4.29a1.4,1.4,0,0,0-1.4-1.4H4.29a1.4,1.4,0,0,0-1.4,1.4h0v14a1.4,1.4,0,0,0,1.4,1.4H12.7a1.4,1.4,0,0,0,1.4,1.4h5.61a1.4,1.4,0,0,0,1.4-1.4h0V9.9a1.4,1.4,0,0,0-1.4-1.4ZM9.2,19a.7.7,0,1,1,.7-.7h0A.71.71,0,0,1,9.2,19ZM12.7,9.9v7H5a.71.71,0,0,1-.7-.7V5a.7.7,0,0,1,.7-.7H13.4a.7.7,0,0,1,.7.7V8.5A1.4,1.4,0,0,0,12.7,9.9Zm7,9.1a.7.7,0,0,1-.7.71H14.8a.76.76,0,0,1-.7-.77V10.6a.7.7,0,0,1,.7-.7H19a.7.7,0,0,1,.7.7V19Z"/>
    <path fill="none" d="M0,0H24V24H0Z"/>
  </svg>',

  'handshake' => /* custom – handshake */ '
  <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <path d="M6.41,4.75l-1.3-.66a.47.47,0,0,0-.63.2l0,.06c0,.2-3,6.53-3,6.53s-.19.52.2.73l1.19.63a.55.55,0,0,0,.77-.17A.37.37,0,0,0,3.64,12l2.95-6.4S6.87,5,6.41,4.75Zm16.13,6.08-3-6.37s-.25-.56-.72-.35l-1.3.66a.5.5,0,0,0-.23.67l0,0c.14.13,3.07,6.51,3.07,6.51s.27.47.67.28l1.21-.58a.6.6,0,0,0,.33-.79ZM16.77,6.15a7.5,7.5,0,0,1-2.47-.43,6.38,6.38,0,0,0-1.63-.28,5,5,0,0,0-2.29.7H7.2l-.47,1H8.84a3,3,0,0,0-.59,1.53,2.89,2.89,0,0,1-.36,1.68c-.31.92,1,1,1,1A2.44,2.44,0,0,0,11,9.2a1.3,1.3,0,0,1,1.73-.6l5.85,5.32A.86.86,0,0,1,18.72,15a.78.78,0,0,1-.91.32l-4.14-3.07c-.75-.19-.51.54-.51.54l4,3.05a.72.72,0,0,1,0,.82c-.22.4-.74.18-.74.18l-3.63-2.68c-.7-.05-.43.6-.43.6L15.45,17a.65.65,0,0,1,.11.83.59.59,0,0,1-.75.26L11.93,16c-.71-.1-.49.52-.49.52l1.94,1.53c-.05.86-.87.52-.87.52l-.52-.4c-.4-.29-.62-.48-.62-.48l-.57-.44a1.12,1.12,0,0,0-.34-.77c-.3-.38-.92-.22-.92-.22a2.55,2.55,0,0,1-.3-.26,1.09,1.09,0,0,0-1-1.18,1.08,1.08,0,0,0-.31,0l-.2-.23a1.34,1.34,0,0,0-.17-1.05c-.32-.6-1.24-.38-1.24-.38l-1.4-1.85-.4.89L5.7,13.82,4.9,15A1,1,0,0,0,5,16.26a1.12,1.12,0,0,0,1.69-.05,1.12,1.12,0,0,0,.11,1.4,1.07,1.07,0,0,0,1.61-.09c-.49.88,0,1.29,0,1.29,1,1,1.77-.33,1.77-.33a1,1,0,0,0,.18,1.26c.95.73,1.61-.57,1.61-.57a1.36,1.36,0,0,0,1,.27,1.29,1.29,0,0,0,1.05-.88,1.42,1.42,0,0,0,1.8.14,1.28,1.28,0,0,0,.54-1.07,1.27,1.27,0,0,0,1.27-.39,1.34,1.34,0,0,0,.4-1.14,1.47,1.47,0,0,0,1.33-.75,1.73,1.73,0,0,0-.22-2l.45-1.07Z"/>
    <path fill="none" d="M0,0H24V24H0Z"/>
  </svg>',

	'search' => /* custom – search */ '
  <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<path d="M21.29,19.83l-4.47-4.47a.43.43,0,0,0-.31-.12H16a7.65,7.65,0,1,0-.78.78v.49a.43.43,0,0,0,.12.31l4.47,4.47a.44.44,0,0,0,.63,0h0l.83-.83a.43.43,0,0,0,0-.62ZM10.23,16.12a5.89,5.89,0,1,1,5.89-5.89,5.89,5.89,0,0,1-5.89,5.89Z"/>
		<path fill="none" d="M0,0H24V24H0Z"/>
	</svg>',
