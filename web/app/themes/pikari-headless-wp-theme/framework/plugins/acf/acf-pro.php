 ...
 */
function d6_get_field( $key, $id = false, $default = null, $format_value = true ) {
  global $post;
 ...
 * @param bool   $format_value Whether or not to format the value loaded from the db.
 */
function d6_the_field( $key, $id = false, $default = '', $format_value = true ) {
  echo d6_get_field( $key, $id, $default, $format_value );
}
 ...
 * @param string $default The default fallback value. Will be returned if ACF Pro is not activated.
 */
function d6_get_sub_field( $key, $default = '' ) {
 ...
 * @param string $default The default fallback value. Will be returned if ACF Pro is not activated.
 */
function d6_the_sub_field( $key, $default = '' ) {
  echo d6_get_sub_field( $key, $default );
}
 ...
 * @param int    $id      The post ID.
 */
function d6_have_rows( $key, $id = false ) {
