...
function register_video_overlay_block() {
  ...
  acf_register_block_type(
    array(
      ...
      'render_callback'   => 'd6_video_overlay_block_render_callback',
...
function d6_video_overlay_block_render_callback( $block, $content = '', $is_preview = false, $post_id = 0 ) {

  //Only Show in backend
  //if ( ! $is_preview ) return;

  //Add the video modal code and YoutubeJS to the bottom of the page
  add_action( 'd6_body_end', function() {
