...
<section class="latest-post bg-fractal-bottom-center md:bg-fractal-bottom-right pt-24 lg:pt-32 pb-20 overflow-hidden">
  <div class="container-narrow mx-auto ">
    <?php
      ...
      $latest_post = pikari_get_latest_post();
...
<?php
  $featured_posts = pikari_get_featured_posts( 3, array($latest_post_id) );
  ...
  <div class="container-slider mx-auto">
    ...
    <div class="featured-posts-slider content-center items-center glide team-member-slider">
      ...
      <div class="glide__arrows hidden md:inline-block lg:hidden" data-glide-el="controls">
        <button class="glide__arrow glide__arrow--left" data-glide-dir="&#60;"><?= pikari_get_icon_svg('chevron_left_thin', 94); ?></button>
        <button class="glide__arrow glide__arrow--right" data-glide-dir="&#62;"><?= pikari_get_icon_svg('chevron_right_thin', 94); ?></button>
      </div>
...
<section class="pt-12 pb-6">
  <div class="container-narrow mx-auto flex flex-col lg:flex-row">
    <?php do_action( 'pikari_archive_start' ); ?>

    <?php if ( is_active_sidebar( 'sidebar-blog' ) && !is_search() ) : ?>

      <div class="blog-sidebar lg:w-1/5 lg:ml-4 ">
        <?php dynamic_sidebar( 'sidebar-blog' ); ?>
      </div>

    <?php endif; ?>

    <div class="post-archive w-full lg:w-4/5 mx-auto lg:order-first">
      ...
      <?php if ( have_posts() ) :
        ...
        echo '<div class="archive-pagination border-gray-300 border-t-2 border-solid py-4">';
          pikari_posts_pagination();
        echo '</div>';

        do_action( 'pikari_archive_loop_end' );
    ...
    <?php do_action( 'pikari_archive_end' ); ?>
